oUl = document.getElementsByClassName("ul_banner")[0];
			var li_write = '';
			for (var i = 1 ; i < 5 ;i++){
				li_write += `<li class = "li_banner"><img class="anime_img chisaki_img" src="img/okaashii/`+i+`.jpg"></li>\n`;
			}
			li_write += `<li class = "li_banner"><img class="anime_img chisaki_img" src="img/okaashii/`+1+`.jpg"></li>`
